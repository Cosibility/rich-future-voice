  ...
  if (marker.exit_code === 78) {
    return i18next.t('errors.crash_port_in_use', {
      defaultValue:
        ...
        'Rich Future Voice (or an app that claimed that port) is holding it. Quit the other instance ' +
  ...
  if (isNativeFault(marker)) {
    ...
    return i18next.t('errors.crash_native_fault', {
      defaultValue:
        ...
        'switch to a crash-isolated engine in Model Catalogue → Engines — "Rich Future Voice (subprocess)" ' +
