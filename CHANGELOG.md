...
- Rich Future Colab now installs the exact production Python graph from `uv.lock`, pins uv itself, and overrides vulnerable frontend transitive dependencies with audited patch releases.
